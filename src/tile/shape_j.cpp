...
void ShapeJ::resetShape(const tile_sprites& type, const int& defaultTileX, const int& defaultTileY)
{ 
    ...
    {
        temp->setAbsoluteCoordinate(defaultTileX+(-1)*g_tile_length, defaultTileY);
    }
    m_tile_vector.push_back(temp);
}
